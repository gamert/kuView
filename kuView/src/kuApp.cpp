...
bool kuApp::OnInit() {
    ...
    mLocale = NULL;
    mFrame = NULL;
	mPath=wxString(*argv).BeforeLast(wxFileName::GetPathSeparator());
    ...
    mFrame->mAssociationExecute=wxString::Format(wxT("\"%s\""),*argv);
    mFrame->mShellExecute=wxString::Format(wxT("\"%s\" \"%%1\""),*argv);
